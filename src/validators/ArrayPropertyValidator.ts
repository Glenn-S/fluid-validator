  ...
  extends BasePropertyValidator<PropKey, Value, Context>
{
  ...
  public forEach(
    ...
    message?: string
  ): ArrayPropertyValidator<PropKey, Value, Context> {
    if (this.value === undefined || this.value === null) {
  ...
  public isNull(message?: string | undefined): ArrayPropertyValidator<PropKey, Value, Context> {
    super.isNull(message);
    return this;
  }

  public isUndefined(message?: string | undefined): ArrayPropertyValidator<PropKey, Value, Context> {
